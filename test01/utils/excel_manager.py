...
class ExcelManager:
    ...
    HEADERS = [
        ...
        "passed_tests",
        "failed_tests",
        "passed_tests_correct",
        "failed_tests_correct",
        "rate_correct",
        "passed_tests_wrong",
        "failed_tests_wrong",
        "rate_wrong",
    ...
    def add_row(self, data: Dict[str, Any]):
        ...
        for col, header in enumerate(self.HEADERS, 1):
            ...
            self.sheet.cell(row=row_index, column=col, value=cell_value)
    ...
    def update_row(self, row_index: int, data: Dict[str, Any]):
        ...
        for col, header in enumerate(self.HEADERS, 1):
            if header in data:
                self.sheet.cell(row=row_index + 1, column=col,
                                value=data[header])
    ...
    def set_column_width(self):
        ...
        column_widths = {
            ...
            "passed_tests": 15,
            "failed_tests": 15,
            "passed_tests_correct": 18,
            "failed_tests_correct": 18,
            "rate_correct": 15,
            "passed_tests_wrong": 18,
            "failed_tests_wrong": 18,
            "rate_wrong": 15,
            "coverage": 15
        }
        ...
        for col, header in enumerate(self.HEADERS, 1):
            ...
            self.sheet.column_dimensions[self.sheet.cell(
